...
uni_prf_metrics.py
==================
Compute heavy-hitter precision, recall, and F1 score for UNI across memory
budgets from 16KB to 256KB.
"""

# python3 uni/code/uni_prf_metrics.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="UNI heavy-hitter precision/recall/F1 experiment.")
    ap.add_argument("--csv", default=str(REPO_ROOT / "dataset/UNI/univ1_pt0.csv"),
                    help="Path to UNI CSV trace file")
    ap.add_argument("--output", default=str(REPO_ROOT / "uni/results/uni_prf_results.json"),
    ...
    packets = load_trace(Path(args.csv), args.sample or None)
