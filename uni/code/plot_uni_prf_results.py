"""
plot_uni_prf_results.py
=======================
Load saved UNI precision/recall/F1 data and plot the metrics without rerunning
the sketch experiment.
"""

# python3 uni/code/plot_uni_prf_results.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Plot saved UNI precision/recall/F1 results.")
    ap.add_argument("--input", default=str(REPO_ROOT / "uni/results/uni_prf_results.json"),
                    help="Path to saved UNI precision/recall/F1 JSON file")
    ap.add_argument("--output-dir", default=str(REPO_ROOT / "uni/results"),
    ...
    filenames = [
        output_dir / "uni_precision.pdf",
        output_dir / "uni_recall.pdf",
        output_dir / "uni_f1_score.pdf",
    ]
