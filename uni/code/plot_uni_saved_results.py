"""
plot_uni_saved_results.py
=========================
Load saved UNI sketch experiment data and plot the metrics without rerunning
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Plot saved UNI sketch experiment results.")
    ap.add_argument("--input", default="uni_sketch_results.json",
                    help="Path to saved UNI results JSON file")
    args = ap.parse_args()
    ...
    filenames = ['uni_throughput.pdf', 'uni_are_top20.pdf', 'uni_are_all.pdf', 'uni_are_hh.pdf']
