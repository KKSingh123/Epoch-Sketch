"""
plot_caida_prf_results.py
=========================
Load saved CAIDA precision/recall/F1 data and plot the metrics without
rerunning the sketch experiment.
"""

# python3 caida/code/plot_caida_prf_results.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Plot saved CAIDA precision/recall/F1 results.")
    ap.add_argument("--input", default=str(REPO_ROOT / "caida/results/caida_prf_results.json"),
                    help="Path to saved CAIDA precision/recall/F1 JSON file")
    ap.add_argument("--output-dir", default=str(REPO_ROOT / "caida/results"),
    ...
    filenames = [
        output_dir / "precision.pdf",
        output_dir / "recall.pdf",
        output_dir / "f1_score.pdf",
    ]
