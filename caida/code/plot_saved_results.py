...
======================
Load saved sketch experiment data and plot the metrics without rerunning the sketch experiment.
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Plot saved sketch experiment results.")
    ...
    filenames = ['throughput.pdf', 'are_top20.pdf', 'are_all.pdf', 'are_hh.pdf']
