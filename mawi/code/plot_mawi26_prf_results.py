"""
plot_mawi26_prf_results.py
==========================
Load saved MAWI26 precision/recall/F1 data and plot the metrics without
rerunning the sketch experiment.
"""

# python3 mawi/code/plot_mawi26_prf_results.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Plot saved MAWI26 precision/recall/F1 results.")
    ap.add_argument("--input", default=str(REPO_ROOT / "mawi/results/mawi26_prf_results.json"),
                    help="Path to saved MAWI26 precision/recall/F1 JSON file")
    ...
    filenames = [
        output_dir / "mawi26_precision.pdf",
        output_dir / "mawi26_recall.pdf",
        output_dir / "mawi26_f1_score.pdf",
    ]
