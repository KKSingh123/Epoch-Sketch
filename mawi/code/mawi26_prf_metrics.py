"""
mawi26_prf_metrics.py
=====================
Compute heavy-hitter precision, recall, and F1 score for MAWI26 across
memory budgets from 16KB to 256KB.
"""

# python3 mawi/code/mawi26_prf_metrics.py
...
def main() -> None:
    ap = argparse.ArgumentParser(description="MAWI26 heavy-hitter precision/recall/F1 experiment.")
    ap.add_argument("--dat", default=str(REPO_ROOT / "dataset/Mawi/mawi26.dat"),
                    help="Path to MAWI26 .dat trace file")
    ap.add_argument("--output", default=str(REPO_ROOT / "mawi/results/mawi26_prf_results.json"),
