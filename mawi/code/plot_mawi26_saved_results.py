"""
plot_mawi26_saved_results.py
============================
Load saved MAWI26 sketch experiment data and plot the metrics without rerunning
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Plot saved MAWI26 sketch experiment results.")
    ap.add_argument("--input", default="mawi26_sketch_results.json",
    ...
    filenames = ['mawi26_throughput.pdf', 'mawi26_are_top20.pdf', 'mawi26_are_all.pdf', 'mawi26_are_hh.pdf']
