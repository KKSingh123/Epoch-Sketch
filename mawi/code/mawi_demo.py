...
mawi_demo.py
============
Compare sketches on a MAWI trace:
...
Usage
-----
    python mawi/code/mawi_demo.py --dat dataset/Mawi/mawi.dat --sample 100000
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Sketch comparison on MAWI trace.")
