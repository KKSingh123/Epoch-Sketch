"""
mawi26_memory_experiment.py
===========================
Run all sketches on MAWI26 trace with varying memory budgets (16KB to 256KB)
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Sketch comparison memory experiment on MAWI26 trace.")
...
def _run(args) -> None:
    ...
    # ------------------------------------------------------------------
    output_file = 'mawi26_sketch_results.json'
    save_data = {
        'dataset': 'MAWI26',
        'dat': args.dat,
        'memories': memories,
    ...
    filenames = ['mawi26_throughput.png', 'mawi26_are_top20.png', 'mawi26_are_all.png', 'mawi26_are_hh.png']
